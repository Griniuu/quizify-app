...
var BrowserCacheManager = class extends CacheManager {
  ...
  removeAccessToken(key, correlationId, updateTokenKeys = true) {
    ...
    (_a = this.performanceClient) == null ? void 0 : _a.incrementFields({ accessTokensRemoved: 1 }, correlationId);
    ...
    try {
      ...
      try {
        ...
        if (((_a = validRequest.account) == null ? void 0 : _a.homeAccountId) && validRequest.postLogoutRedirectUri && authClient.authority.protocolMode === ProtocolMode.OIDC) {
          void this.browserStorage.removeAccount((_b = validRequest.account) == null ? void 0 : _b.homeAccountId, this.correlationId);
      ...
      if (authClient.authority.protocolMode === ProtocolMode.OIDC) {
        try {
          ...
          if ((_a = validLogoutRequest.account) == null ? void 0 : _a.homeAccountId) {
            void this.browserStorage.removeAccount((_b = validLogoutRequest.account) == null ? void 0 : _b.homeAccountId, this.correlationId);
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-FJ6GVAWV.js");
    }
  } catch (e) {
  }
  return void 0;
